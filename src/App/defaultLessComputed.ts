...
@primary-color-outline: fade(@base-primary, @outline-fade);

@processing-color: @primary-color;

// >>> Info
@info-color: @base-primary;
@info-color-deprecated-bg: @blue-1;
@info-color-deprecated-border: @blue-3;

// >>> Success
@success-color: @green-6;
@success-color-hover: @green-5;
@success-color-active: @green-7;
@success-color-outline: fade(@green-6, @outline-fade);
...
@warning-color-outline: fade(@gold-6, @outline-fade);
@warning-color-deprecated-bg: @gold-1;
@warning-color-deprecated-border: @gold-3;

// error base is @red-5, turns out that it can't be reuse
// >>> Error
@error-color: @red-5;
@error-color-hover: #ff7875;
@error-color-active: #d9363e;
@error-color-outline: fade(@red-5, @outline-fade);
